...
\begin{figure}[t!]
	\centering
	\includegraphics[width=0.95\linewidth]{Diagramas/DftInputSignal.pdf}
	\caption{Input signal $x[n]$ in time domain}
	\label{fig:dftinputsignal}
\end{figure}
\begin{figure}[t!]
	\centering
	\includegraphics[width=\linewidth]{Diagramas/DftFixedPoint.pdf}
...
\begin{figure}[t!]
	\centering
	\includegraphics[width=0.45\linewidth]{Diagramas/miSeccionFiguras/Shift.pdf}
