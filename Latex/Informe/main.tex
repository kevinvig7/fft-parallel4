...
In Fig. \ref{fig:8ponits_df} and Fig. \ref{fig:8ponits_dfg} is shown the equivalent diagram of interconnections and data flows from the equations presented in (\ref{eqn:radix}).
