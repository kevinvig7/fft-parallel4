...
\begin{figure}%[ht]
\centering
\includegraphics[width=\linewidth]{Diagramas/Butter16.png}
...
\begin{figure}[ht]
\centering
 \includegraphics[width=\linewidth]{Diagramas/Butter16_pipe.png}%
...
\begin{figure}[ht]
\centering
 \includegraphics[width=\linewidth]{Diagramas/tab-life-a.png}%
...
\begin{figure}[ht]
\centering
 \includegraphics[width=0.7\linewidth]{Diagramas/tab-life-b.png}%
...
\begin{figure}[ht]
\centering
 \includegraphics[width=0.8\linewidth]{Diagramas/tab-life-c.png}%
...
\begin{figure*}[h!]
\centering
 \includegraphics[width=0.95\linewidth]{Diagramas/folding-128.png}%
...
%%%%%%%%%
\section{CONCLUSION}
% cito \cite{garrido_pipelined_2013}, \cite{parhi_synthesis_1992}
...
\begin{figure*}[htbp]
\centering
 \includegraphics[width=\linewidth]{Diagramas/bubble_delays_128.png}%
...
\begin{figure}[!h]
\centering
 \includegraphics[width=\linewidth]{Diagramas/V5_esquema.eps} \\ %
\hfill
\hfill
\hfill
\hfill
\hfill
 ...
 \includegraphics[width=\linewidth]{Diagramas/V5_esquema.eps}%
 %\includegraphics[width=1.5\textwidth]{Diagramas/V5_esquema.eps}%
%\caption{Pipelined DFG of a 128-point DIF FFT as a preprocessing step for folding.}
%\label{fig:pipe_dfg_128}
\end{figure}
 \vspace*{\fill}
