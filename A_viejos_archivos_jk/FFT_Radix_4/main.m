...
a2=a1/max(a1);% normalizamos la amplitud maxima de la señal, para que no haya armonicos


p=nextpow2(length(a2));      %%para hacer el largo de la señal potencia de 2 llenando de ceros 
