...
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data1_0.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data1_1.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data1_2.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data2_0.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data2_1.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data2_2.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data2_3.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data3_0.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data3_1.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data4_0.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data4_1.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data4_2.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data4_3.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data5_0.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data5_1.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data5_2.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
...
fclose(fid);
%%%%%%%%%%%%%%%%%
fid=fopen ('C:\fft-parallel4\verilog\topfftsrcN128\v\coeff_data5_3.v','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
fprintf(fid,['`timescale 1ns / 1ps' , '\n']);
