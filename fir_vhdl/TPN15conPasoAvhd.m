...
pp_fx=fi(zeros(1,32),1,17,16,'roundmode','floor', 'overflowmode','wrap');%seguir las reglas de producto de las filminas
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pp16_fx=fi(zeros(1,1000),1,17,16,'roundmode','floor', 'overflowmode','wrap');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
accum_fx=fi(0,1,12+5,16,'roundmode','floor','overflowmode','wrap');%seguir las reglas de suma de las filminas
                %24+logen base 2 de cantidad de taps
fid=fopen ('x.dat','wt'); %guardo un archivo con los coef. cuantizados de la señal compuesta de entrada
for i=1:length(a_fx)
    fx=a_fx(i);
    fprintf(fid,[fx.bin '\n']); 
    end
...
pp16_fx.double(n)=pp_fx.double(16);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid=fopen ('pp.dat','wt'); %guardo un archivo con un vector de mil muestras de un producto parcial.
for i=1:length(pp16_fx)        
    pp=pp16_fx(i);
    fprintf(fid,[pp.bin '\n']);
    end
fclose(fid);
...
fid=fopen ('y.dat','wt'); %guardo un archivo con los coef. cuantizados de la señal filtrada de salida
for i=1:length(y_fx)
    fx=y_fx(i);
    fprintf(fid,[fx.bin '\n']);
    end
