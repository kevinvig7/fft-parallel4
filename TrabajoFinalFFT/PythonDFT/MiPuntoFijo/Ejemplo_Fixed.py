...
"""
#------------------
fijo=DeFixedInt(14,12,'S','round','saturate') 
fijo.value=-0.00272673894995  #-0.0078125
print 'Float: ',fijo.fValue,'NBI: %d|'%fijo.intWidth,'NBF: %d|'%fijo.fractWidth,'NB: %d|'%fijo.width
print "\nEntero Equivalente"
print 'Int: %d|'%fijo.intvalue,'Bin: ',bin(fijo.intvalue)
print "\n----> Rango de a: ",fijo.showRange()
#print "\n----> Rango de Objetos: ",fijo.showValueRange()
#------------------
"""
EJEMPLO
"""
...
print "\n----> Rango de Objetos: ",a.showValueRange()
