...
HD_PWD='C:/fft-parallel4/verilog/pruebaPF/pruebaPF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sat.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sat.tcl -notrace
